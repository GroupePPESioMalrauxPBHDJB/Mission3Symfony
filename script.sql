...
--
-- Client: localhost
-- Généré le: Mar 26 Mars 2013 à 11:00
...
(8, '2013-06-28', '9h-12h et 13h30 - 19h', 'Laboratoire', 'Lycée Carnot 160 rue du Jambon 54 510 Tomblaine', '55 € support de cours inclus', 'A charge des participants', '2013-06-01', NULL, 1, 0),
...
INSERT INTO `inscription` (`id`, `nbInscrit`, `id_organisation`, `id_formation`) VALUES
(12, 69, 1, 1),
(13, 12, 1, 2),
(14, 67, 2, 4);
...
INSERT INTO `organisation` (`id`, `nom`, `mail`, `nom_responsable`, `prenom_responsable`) VALUES
(1, 'test', 'test@lam.ffr', 'bla', 'bli'),
(2, 'macin', 'edf@bidule.fr', 'blo', 'blu');
...
ALTER TABLE `inscription`
  ADD CONSTRAINT `inscription_ibfk_1` FOREIGN KEY (`id_organisation`) REFERENCES `organisation` (`id`),
  ADD CONSTRAINT `inscription_ibfk_2` FOREIGN KEY (`id_formation`) REFERENCES `formation` (`id`);
